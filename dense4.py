...
dense_1 = Dense(200, init='normal',activation='relu')(input)
...
cv_df.to_csv('DENSE4cv_results.csv')
...
train_df.to_csv('DENSE4train_results.csv')
...
test_df.to_csv('DENSE4test_results.csv')

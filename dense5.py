...
dense_0 = Dense(500, activation='relu')(input)#,,kernel_constraint=UnitNorm(axis=0)
bn_1=BatchNormalization()(dense_0)
dropout_0=Dropout(0.5)(bn_1)

dense_1 = Dense(200,activation='relu')(dropout_0)
...
dense_4 = Dense(30, activation='relu')(dropout_2)
...
cv_df.to_csv('DENSE5cv_results.csv')
...
train_df.to_csv('DENSE5train_results.csv')
...
test_df.to_csv('DENSE5test_results.csv')
